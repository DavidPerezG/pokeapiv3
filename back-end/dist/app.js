...
var pokemonRoutes = require('./routes/pokemonRoutes');
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, pokemonService.getEveryPokemon()];
            case 1:
                // Wait for the Pokémon data to be fetched
                allPokemons = _a.sent();
                allPokemons.sort(function (a, b) { return a.name.localeCompare(b.name); });
            ...
            case 2:
                error_1 = _a.sent();
                console.error('Error fetching Pokémon data:', error_1.message);
                return [3 /*break*/, 3];
